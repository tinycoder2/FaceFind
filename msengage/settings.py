"""
Django settings for msengage project.
...
SECRET_KEY = 'django-insecure-xgfz+t%xz6m=$sf6af@=^hm%+ew&#pscf$7(+x56f_u*&l(fz$'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'facefindxyz@gmail.com'
